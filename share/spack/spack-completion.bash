...
_spack () {
    ...
    then
        ...
        compgen -W "activate add arch blame bootstrap build build-env buildcache cd checksum clean clone commands compiler compilers concretize config configure create deactivate debug dependencies dependents deprecate dev-build diy docs edit env extensions fetch find flake8 gc gpg graph help info install license list load location log-parse maintainers mirror module patch pkg providers pydoc python reindex release-jobs remove repo resource restage setup spec stage test uninstall unload upload-s3 url verify versions view" -- "$cur"
    fi
}
...
_spack_checksum () {
    ...
    then
        ...
        compgen -W "package versions" -- "$cur"
    fi
}
...
_spack_compiler () {
    ...
    then
        ...
        compgen -W "find remove list info" -- "$cur"
    fi
}
...
_spack_env () {
    ...
    then
        ...
        compgen -W "activate deactivate create remove list status loads view" -- "$cur"
    fi
}
...
_spack_env_view () {
    ...
    then
        ...
        compgen -W "{regenerate,enable,disable} view_path" -- "$cur"
    fi
}
...
_spack_mirror () {
    ...
    then
        ...
        compgen -W "create add remove set-url list" -- "$cur"
    fi
}
...
_spack_repo () {
    ...
    then
        ...
        compgen -W "create list add remove" -- "$cur"
    fi
}
...
_spack_repo_create () {
    ...
    then
        ...
        compgen -W "directory namespace" -- "$cur"
    fi
}
...
_spack_repo_remove () {
    ...
    then
        ...
        compgen -W "path_or_namespace" -- "$cur"
    fi
}
...
_spack_test () {
    if $list_options
    then
        compgen -W "-h --help -H --pytest-help -l --list -L --list-long -N --list-names --extension -s -k --showlocals" -- "$cur"
    else
        compgen -W "pytest_args" -- "$cur"
    fi
}
...
_spack_view () {
    ...
    then
        ...
        compgen -W "symlink hardlink remove statlink" -- "$cur"
    fi
}
