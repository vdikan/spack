## -*- docker-image-name: "vdikan/siesta-spack" -*-

FROM ubuntu:18.04
# Custom Spack image based on Spack's Ubuntu-Bionic:
# https://hub.docker.com/r/spack/ubuntu-bionic/dockerfile

# All credit goes to Spack dev team and maintainers:
# MAINTAINER Spack Maintainers <maintainers@spack.io>

MAINTAINER Vladimir Dikan <vdikan@vivaldi.net>
